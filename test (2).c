...
void text2(void)											// to draw the text in menu screen
{
	...
	glColor3f(1.4,3.9,0.78);
	drawstring(160.0,465.0,1.0,"TRANSMITIING USING SELECTIVE REPEAT ARQ");
...
void text1(void)											// to draw the text in menu screen
{

	setFont(GLUT_BITMAP_HELVETICA_18);
	glColor3f(1.4,3.9,0.78);
	drawstring(175.0,465.0,1.0,"OSI MODEL(with its 7 layers)");

	
	setFont(GLUT_BITMAP_HELVETICA_18);
	glColor3f(1.0,1.0,1.0);
	drawstring(30.0,405.0,1.0," APPLICATION LAYER");
	
	glColor3f(1.0,1.0,1.0);
	drawstring(25.0,350.0,1.0,"PRESENTATION LAYER");
				

	glColor3f(1.0,1.0,1.0);
	drawstring(30.0,295.0,1.0,"   SESSION LAYER");

	glColor3f(1.0,1.0,1.0);
	drawstring(30.0,240.0,1.0,"  TRANSPORT LAYER");

	glColor3f(1.0,1.0,1.0);
	drawstring(30.0,185.0,1.0,"   NETWORK LAYER");

	glColor3f(1.0,1.0,1.0);
	drawstring(30.0,130.0,1.0,"  DATALINK LAYER");
	
	glColor3f(1.0,1.0,1.0);
	drawstring(30.0,80.0,1.0,"   PHYSICAL LAYER");
	

	
	glColor3f(1.0,1.0,1.0);
	drawstring(335.0,405.0,1.0,"APPLICATION LAYER");

	glColor3f(1.0,1.0,1.0);
	drawstring(335.0,350.0,1.0,"PRESENTATION LAYER");				

	glColor3f(1.0,1.0,1.0);
	drawstring(335.0,295.0,1.0,"    SESSION LAYER");

	glColor3f(1.0,1.0,1.0);
	drawstring(335.0,240.0,1.0,"  TRANSPORT LAYER");

	glColor3f(1.0,1.0,1.0);
	drawstring(335.0,185.0,1.0,"    NETWORK LAYER");

	glColor3f(1.0,1.0,1.0);
	drawstring(335.0,130.0,1.0,"  DATALINK LAYER");
	
	glColor3f(1.0,1.0,1.0);
	drawstring(335.0,80.0,1.0,"     PHYSICAL LAYER");
	glFlush();
...
void draw11() 
{
	...
	drawstring(130.0,215.0,1.0,"Click continue(C) to know how transmission happens....");
	glLineWidth(15);
	glBegin(GL_LINES);
		glColor3f(1.4,3.9,0.78);
		glLineWidth(15);
...
void draw12() // TO DRAW POLYGON FOR DISPLAY MENUS 
{
...
void title()												// to draw the starting screen
{
	...
	glColor3f(1.4,1.9,0.78);
	setFont(GLUT_BITMAP_HELVETICA_18);
	drawstring(200.0,465.0,1.0,"O S I    M O D E L");
	...
	glColor3f(0.0,1.0,1.0);
	drawstring(280.0,230.0,1.0,"RANJITHA");
	setFont(GLUT_BITMAP_HELVETICA_18);

	glColor3f(0.0,1.0,1.0);
	drawstring(360.0,230.0,1.0,"RAMYA");
	
	glColor3f(0.0,1.0,1.0);
	drawstring(280.0,200.0,1.0,"1RN14CS083");	
	
	glColor3f(0.0,1.0,1.0);
	drawstring(360.0,200.0,1.0,"1RN14CS082");		
...
void myMouse(int btn, int state, int x, int y)
{
	...
	if(btn==GLUT_LEFT_BUTTON && state == GLUT_DOWN )
	{
		x=x/2;
		y=(1000-y)/2.1;
		if ((x>=100 && x<=400) && (y>=405 && y<=435 ))// 1 menu
		...
		if((x>=100 && x<=400) && (y>=355 && y<=385 ))//   2 menu
		{
			draw2();
			draw6();
		...
		if((x>=100 && x<=400) && (y>=325 && y<=345 ))  // 3 menu
		{
				draw3();
				//delay();
				draw6();
		...
		if((x>=100 && x<=400) && (y>=290 && y<=315 ))  // 4 menu
		{
				draw4();
				//delay();
				draw6();
		...
		if((x>=100 && x<=400) && (y>=250 && y<=275 ))  // 5 menu
		{
				draw5();
				//delay();
				draw6();
		...
		if((x>=100 && x<=400) && (y>=210 && y<=235 ))  // 6 menu
		{
				exit(0);
		}
